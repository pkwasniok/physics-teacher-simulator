...
cursor.execute('CREATE TABLE questions (id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, author_email VARCHAR(50) NOT NULL, question MEDIUMTEXT NOT NULL, branch VARCHAR(50) NOT NULL)')
